...
class SecretMenuState extends MusicBeatState
{
	...
	private var AllPossibleSongs:Array<String> = [];
	...
	override function create()
	{
		...
		CurrentSongIcon = new FlxSprite(0,0).loadGraphic(Paths.image('week_icons_' + (AllPossibleSongs[].toLowerCase())));
	...
	public function LoadProperPack()
		{
			...
			{
					addWeek(['goofy-keyboard'], 3, ['jschlatt']);					
                    addWeek(['egg-torsion'], 3, ['pichai']);
                    addWeek(['iniustitiam'], 1, ['krembi']);
                    addWeek(['codekill'], 1, ['emma']
			}
		}
